...
<!-- Include side navigation -->
	...
	<!-- 5. $CONTENT -->
		...
		<div>
			...
			<!-- Info -->
			<div class="panel-group panel-group-default" id="accordion-info-example">
				<s:iterator value="categories">
				<div class="panel">
					<div class="panel-heading">
						<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion-info-example" href="#collapseOne-info<s:property value='category_id'/>">
							<s:property value="category_name"/> <!-- (Your Progress: <s:property value="user_progress"/>%) -->
							<!-- <div class="progress progress-striped active"><div class="progress-bar" style="width: <s:property value='user_progress'/>%;"></div></div> --> 
						</a>
					</div> <!-- / .panel-heading -->
					<div id="collapseOne-info<s:property value='category_id'/>" class="panel-collapse collapse">
								...
								<div class="panel panel-dark panel-body-colorful widget-profile widget-profile-centered">
									...
									<div class="panel-body">
										<div class="widget-profile-text" style="padding: 0;">
											<s:property value="sub_category_name"/> <!-- (Your Progress: <s:property value="user_progress"/>%) -->
		...
		<s:iterator value="testsList">
			...
			<a href="test?t=<s:property value='test_id'/>">
			<div class="col-md-4">
			<!-- 7. Profile widget - Centered example -->
				<div class="panel panel-dark panel-body-colorful widget-profile widget-profile-centered">
					<div class="panel-heading">
