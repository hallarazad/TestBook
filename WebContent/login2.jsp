...
-->
<body class="right-to-left theme-default page-signin">
...
<script>
	...
	<div class="signin-container">
		...
		<div class="signin-form">
			...
			<!-- Form -->
			<s:form action="login" method="post" namespace="/" id="signin-form_id">
				...
				<div class="form-group w-icon">
					<s:textfield name="username" id="username_id" cssClass="form-control input-lg"></s:textfield>
					<!-- <input type="text" name="signin_username" id="username_id" class="form-control input-lg" placeholder="يوزرنيم"> -->
					<span class="fa fa-user signin-form-icon"></span>
				</div> <!-- / Username -->

				<div class="form-group w-icon">
				<s:password name="password" id="password_id" cssClass="form-control input-lg" ></s:password>
					<!-- <input type="password" name="signin_password" id="password_id" class="form-control input-lg" placeholder="پاسورڊ"> -->
					<span class="fa fa-lock signin-form-icon"></span>
				</div> <!-- / Password -->

				<div class="form-actions">
				
					<input type="submit" value="داخل ٿيو" class="signin-btn bg-primary">
					<a href="#" class="forgot-password" id="forgot-password-link">ڇا توهان کان پاسورڊ وسري ويو آهي؟</a>
				</div> <!-- / .form-actions -->
			</s:form>
			<!-- / Form -->
